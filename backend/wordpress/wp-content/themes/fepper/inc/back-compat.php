 ...
 * @since Twenty Fifteen 1.0
 */
function fepper_switch_theme() {
	switch_theme( WP_DEFAULT_THEME, WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'fepper_upgrade_notice' );
}
add_action( 'after_switch_theme', 'fepper_switch_theme' );
 ...
 * @since Twenty Fifteen 1.0
 */
function fepper_upgrade_notice() {
...
add_action( 'load-customize.php', 'fepper_customize' );
...
add_action( 'template_redirect', 'fepper_preview' );
